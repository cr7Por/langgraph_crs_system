...
curl -N -H "Accept: text/event-stream" \
  -G "http://127.0.0.1:8191/query/" \
  --data-urlencode "original_query=我想买一双运动鞋" \
  --data-urlencode "dataset_id=4b8c848eb31011f08b4c22715a4cef8f" \
  --data-urlencode "user_id=User_B" \
  --data-urlencode "thread_id=33a" \
  --data-urlencode "do_web_search=False"

curl -N -H "Accept: text/event-stream" \
  -G "http://127.0.0.1:8191/query/" \
  --data-urlencode "original_query=我想买一辆自行车" \
  --data-urlencode "dataset_id=4b8c848eb31011f08b4c22715a4cef8f" \
  --data-urlencode "user_id=User_B" \
  --data-urlencode "thread_id=33a" \
  --data-urlencode "do_web_search=False"
...
curl -N -H "Accept: text/event-stream" \
  -G "http://117.50.221.99:8191/query/" \
  --data-urlencode "original_query=我想买一辆自行车" \
  --data-urlencode "dataset_id=4b8c848eb31011f08b4c22715a4cef8f" \
  --data-urlencode "user_id=User_B" \
  --data-urlencode "thread_id=33a" \
  ...
  curl -N -H "Accept: text/event-stream" \
  -G "http://117.50.221.99:8191/query/" \
  --data-urlencode "original_query=越野" \
  --data-urlencode "dataset_id=4b8c848eb31011f08b4c22715a4cef8f" \
  --data-urlencode "user_id=User_B" \
  --data-urlencode "thread_id=33a" \
  --data-urlencode "do_web_search=False"
